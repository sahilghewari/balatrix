...
const ServicesOverview = () => {
  ...
  useEffect(() => {
    const context = gsap.context(() => {
      ...
      const translateAmount = scrollWidth - windowWidth + (windowWidth * 0.25);
  ...
  return (
    <section ref={containerRef} className="services-scroll-section relative bg-transparent border-b border-gray-100 h-[220vh] py-0 overflow-visible">
      <div className="services-sticky-wrapper sticky top-0 h-screen flex flex-col justify-center overflow-hidden w-full">
        {/* Premium Background System */}
        <div className="absolute inset-0 bg-gradient-to-b from-gray-50/80 via-white to-gray-50/40 -z-10"></div>
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-radial from-blue-100/30 to-transparent blur-3xl -z-10"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-radial from-purple-100/20 to-transparent blur-3xl -z-10"></div>

        <div className="relative z-10 w-full">
          {/* Premium Section Header */}
          <div className="text-center mb-6 sm:mb-8 space-y-3 shrink-0 px-4">
            <div className="inline-flex items-center space-x-2 text-xs font-medium text-gray-600 bg-gray-100/60 px-3 py-1.5 rounded-full border border-gray-200/60">
              <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></div>
              <span>Core Services</span>
            </div>

            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 tracking-tight leading-[1.1] max-w-4xl mx-auto">
              Affordable Toll-Free Numbers & Cloud Communication
            </h2>
          ...
          {/* Premium Capabilities Horizontal Row */}
          <div className="w-full overflow-hidden px-[10vw] relative z-10">
            <div ref={rowRef} className="services-cards-row flex flex-row gap-16 w-max">
              {capabilities.map((capability, index) => (
                <div
                  key={index}
                  className="w-[85vw] sm:w-[75vw] md:w-[68vw] lg:w-[58vw] xl:w-[50vw] shrink-0 bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-10 flex flex-col justify-between h-full group relative"
                >
