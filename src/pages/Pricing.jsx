    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-[70vh] bg-gradient-to-br from-white via-gray-50/50 to-gray-50 flex items-center justify-center overflow-hidden relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-20 w-32 h-32 border border-gray-200 rounded-lg transform rotate-12 opacity-30 animate-float" />
          ...
          <div className="absolute top-40 left-20 w-16 h-16 border-2 border-blue-300 rounded-full opacity-20 animate-float" style={{ animationDelay: '4s' }} />
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-20 py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Billing Toggle */}
              <div className="flex items-center gap-4 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
              ...
              <div className="pt-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
                <div className="flex flex-wrap items-center gap-8 text-sm font-medium text-gray-500" style={{ fontFamily: 'Inter, sans-serif' }}>
                  ...
                  <div className="w-px h-4 bg-gray-300" />
                  <div className="flex items-center gap-2">
                    <span className="text-lg font-bold text-gray-800">Cancel</span>
                    <span>Anytime</span>
                  </div>
                </div>
              </div>
            ...
            <div className="hidden lg:block opacity-0 animate-fade-in-right" style={{ animationDelay: '1.1s', animationFillMode: 'forwards' }}>
              <div className="relative h-96 flex items-center justify-center">
                <div className="text-center space-y-6">
                  <div className="text-6xl font-bold text-green-600">$9.99</div>
                  <div className="text-lg text-gray-900 font-semibold">Starting from</div>
